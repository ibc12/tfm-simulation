             ...
             int neutronPS, int protonPS)
{
    ...
    {
        //Get DF
        ROOT::RDataFrame df("SimulationTTree", TString::Format("/home/fica/Ivan/tfm-simulation/Outputs/%.1fMeV/transfer_TRIUMF_Eex_%.3f_nPS_%d_pPS_%d.root", T1, Ex, neutronPS, protonPS));
